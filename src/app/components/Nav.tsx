...
const Nav = ({ children, isFixed = false, isMobile = false}: NavProps) => {
  const fixed =
    "fixed animate-fade-in-down-fixed flex top-[-20px] justify-between items-center pt-2 md:pt-4 pb-8 px-5 lg:px-28 w-full bg-gradient-to-b from-black from-60% to-transparent z-20";
  const absolute =
